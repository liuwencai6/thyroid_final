...
# 数据读取，特征标注
thyroid_train = pd.read_csv('111.csv', low_memory=False)
features = ['Age',  'Echogenicity', 'Shape', 'Margin','Echogenic.Foci', 'Lymph.Nodes']
target = 'Final'
#处理数据不平衡
...
sp = 0.5
#figure
is_t = (XGB.predict_proba(np.array([[Age, Echogenicity, Shape,Margin, Echogenic_Foci,Lymph_Nodes]]))[0][1])> sp
prob = (XGB.predict_proba(np.array([[Age, Echogenicity, Shape,Margin, Echogenic_Foci, Lymph_Nodes]]))[0][1])*1000//1/10
